import { b as e } from './function-call-LNN5-qQc.js';
function t(e, t) {
  return function () {
...
const { toString: n } = Object.prototype,
  ...
  { iterator: o, toStringTag: s } = Symbol,
  i = ((e) => (t) => {
    const r = n.call(t);
...
const p = c('string'),
  ...
  O = a('FileList'),
  R = a('URLSearchParams'),
  [S, T, A, v] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(a);
      ...
      : q
        ? ((M = `axios@${Math.random()}`),
          ...
          x.addEventListener(
            'message',
            ({ source: e, data: t }) => {
              e === x && t === M && I.length && I.shift()();
            },
            !1,
          ),
          (e) => {
            (I.push(e), x.postMessage(M, '*'));
          })
        : (e) => setTimeout(e));
var D, q, M, I;
const z = 'undefined' != typeof queueMicrotask ? queueMicrotask.bind(x) : ('undefined' != typeof process && process.nextTick) || B,
  H = {
    isArray: l,
    isArrayBuffer: d,
    isBuffer: f,
    isFormData: (e) => {
      ...
      return (
        ...
        (('function' == typeof FormData && e instanceof FormData) ||
          (h(e.append) && ('formdata' === (t = i(e)) || ('object' === t && h(e.toString) && '[object FormData]' === e.toString()))))
      );
    },
    ...
    forEach: j,
    merge: function e() {
      const { caseless: t, skipUndefined: n } = (N(this) && this) || {},
        r = {},
        o = (o, s) => {
          const i = (t && C(r, s)) || s;
          g(r[i]) && g(o) ? (r[i] = e(r[i], o)) : g(o) ? (r[i] = e({}, o)) : l(o) ? (r[i] = o.slice()) : (n && u(o)) || (r[i] = o);
        };
      for (let s = 0, i = arguments.length; s < i; s++) arguments[s] && j(arguments[s], o);
      return r;
    },
    ...
    isSpecCompliantForm: function (e) {
      return !!(e && h(e.append) && 'FormData' === e[s] && e[o]);
    },
    toJSONObject: (e) => {
...
function Q(e, t, n) {
  ...
  t = t || new FormData();
  const r = (n = H.toFlatObject(n, { metaTokens: !0, dots: !1, indexes: !1 }, !1, function (e, t) {
  ...
  function c(e) {
    ...
    if (!a && H.isBlob(e)) throw new J('Blob is not supported. Use a Buffer instead.');
  ...
  function l(e, n, o) {
    ...
    if (e && !o && 'object' == typeof e)
      if (H.endsWith(n, '{}')) ((n = r ? n : n.slice(0, -2)), (e = JSON.stringify(e)));
        ...
        ((H.isFileList(e) || H.endsWith(n, '[]')) && (a = H.toArray(e)))
      )
        return (
          (n = $(n)),
          a.forEach(function (e, r) {
            !H.isUndefined(e) && null !== e && t.append(!0 === i ? X([n], r, s) : null === i ? n : n + '[]', c(e));
          }),
          !1
        );
    return !!V(e) || (t.append(X(o, n, s), c(e)), !1);
  }
  const u = [],
    f = Object.assign(G, { defaultVisitor: l, convertValue: c, isVisitable: V });
  ...
  return (
    (function e(n, r) {
      if (!H.isUndefined(n)) {
        ...
        (u.push(n),
          H.forEach(n, function (n, s) {
            !0 === (!(H.isUndefined(n) || null === n) && o.call(t, n, H.isString(s) ? s.trim() : s, r, f)) && e(n, r ? r.concat(s) : [s]);
          }),
          u.pop());
      }
    })(e),
...
function ne(e, t, n) {
  ...
  let s;
  if (((s = o ? o(t, n) : H.isURLSearchParams(t) ? t.toString() : new Y(t, n).toString(r)), s)) {
    const t = e.indexOf('#');
...
const oe = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
  se = {
    isBrowser: !0,
    classes: {
  ...
  ae = ('object' == typeof navigator && navigator) || void 0,
  ce = ie && (!ae || ['ReactNative', 'NativeScript', 'NS'].indexOf(ae.product) < 0),
  le = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && 'function' == typeof self.importScripts,
  ue = (ie && window.location.href) || 'http://localhost',
  fe = {
    ...Object.freeze(
      Object.defineProperty(
        { __proto__: null, hasBrowserEnv: ie, hasStandardBrowserEnv: ce, hasStandardBrowserWebWorkerEnv: le, navigator: ae, origin: ue },
        Symbol.toStringTag,
        { value: 'Module' },
      ),
    ),
...
function de(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (((s = !s && H.isArray(r) ? r.length : s), a)) return (H.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i);
    (r[s] && H.isObject(r[s])) || (r[s] = []);
    return (
      t(e, n, r[s], o) &&
        H.isArray(r[s]) &&
        (r[s] = (function (e) {
...
const pe = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      if (H.isFormData(e)) return r ? JSON.stringify(de(e)) : e;
      ...
      if (o) {
        if (n.indexOf('application/x-www-form-urlencoded') > -1)
          return (function (e, t) {
            return Q(e, new fe.classes.URLSearchParams(), {
              visitor: function (e, t, n, r) {
                return fe.isNode && H.isBuffer(e) ? (this.append(t, e.toString('base64')), !1) : r.defaultVisitor.apply(this, arguments);
              },
              ...t,
            });
    ...
    function (e) {
      ...
      if (e && H.isString(e) && ((n && !this.responseType) || r)) {
        ...
        try {
          ...
          if (n) {
            if ('SyntaxError' === o.name) throw J.from(o, J.ERR_BAD_RESPONSE, this, null, this.response);
            throw o;
          }
        }
      }
...
function ge(e) {
  return !1 === e || null == e ? e : H.isArray(e) ? e.map(ge) : String(e);
}
function ye(e, t, n, r, o) {
  return H.isFunction(r)
    ? r.call(this, t, n)
    : (o && (t = n), H.isString(t) ? (H.isString(r) ? -1 !== t.indexOf(r) : H.isRegExp(r) ? r.test(t) : void 0) : void 0);
}
let we = class {
  constructor(e) {
    e && this.set(e);
  ...
  set(e, t, n) {
    ...
    function o(e, t, n) {
      ...
      (!s || void 0 === r[s] || !0 === n || (void 0 === n && !1 !== r[s])) && (r[s || t] = ge(e));
    }
    const s = (e, t) => H.forEach(e, (e, n) => o(e, n, t));
    if (H.isPlainObject(e) || e instanceof this.constructor) s(e, t);
      ...
      for (const t of e) {
        ...
        o[(r = t[0])] = (n = o[r]) ? (H.isArray(n) ? [...n, t[1]] : [n, t[1]]) : t[1];
      }
      s(o, t);
    } else null != e && o(t, e, n);
    return this;
  ...
  normalize(e) {
    ...
    return (
      H.forEach(this, (r, o) => {
        ...
        if (s) return ((t[s] = ge(r)), void delete t[o]);
        const i = e
          ? (function (e) {
              return e
                .trim()
  ...
  static accessor(e) {
    const t = (this[me] = this[me] = { accessors: {} }).accessors,
      n = this.prototype;
    function r(e) {
      const r = be(e);
      t[r] ||
...
(we.accessor(['Content-Type', 'Content-Length', 'Accept', 'Accept-Encoding', 'User-Agent', 'Authorization']),
  H.reduceDescriptors(we.prototype, ({ value: e }, t) => {
...
const Te = (e, t, n = 3) => {
  ...
  ve =
    ...
    (...t) =>
      H.asap(() => e(...t)),
  je = fe.hasStandardBrowserEnv
    ? ((e, t) => (n) => ((n = new URL(n, fe.origin)), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(
        new URL(fe.origin),
        fe.navigator && /(msie|trident)/i.test(fe.navigator.userAgent),
      )
    : () => !0,
  Ce = fe.hasStandardBrowserEnv
    ? {
        write(e, t, n, r, o, s) {
...
const Ne = (e) => (e instanceof we ? { ...e } : e);
function Pe(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n, r) {
  ...
  function o(e, t, n, o) {
    return H.isUndefined(t) ? (H.isUndefined(e) ? void 0 : r(void 0, e, 0, o)) : r(e, t, 0, o);
  }
  function s(e, t) {
  ...
  const c = {
    ...
    responseEncoding: i,
    validateStatus: a,
    headers: (e, t, n) => o(Ne(e), Ne(t), 0, !0),
  };
  return (
    H.forEach(Object.keys({ ...e, ...t }), function (r) {
      const s = c[r] || o,
        i = s(e[r], t[r], r);
      (H.isUndefined(i) && s !== a) || (n[r] = i);
    }),
    n
  );
}
const Ue = (e) => {
    ...
    if (
      ...
      (t.url = ne(xe(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer)),
      a && i.set('Authorization', 'Basic ' + btoa((a.username || '') + ':' + (a.password ? unescape(encodeURIComponent(a.password)) : ''))),
      H.isFormData(n))
    )
      if (fe.hasStandardBrowserEnv || fe.hasStandardBrowserWebWorkerEnv) i.setContentType(void 0);
    ...
    if (fe.hasStandardBrowserEnv && (r && H.isFunction(r) && (r = r(t)), r || (!1 !== r && je(t.url)))) {
      const e = o && s && Ce.read(s);
      e && i.set(o, e);
    }
    return t;
  },
  Fe =
    ...
    function (e) {
      return new Promise(function (t, n) {
        const r = Ue(e);
        let o = r.data;
        const s = we.from(r.headers).normalize();
        let i,
          a,
          c,
          l,
        ...
        function b() {
          if (!m) return;
          const r = we.from('getAllResponseHeaders' in m && m.getAllResponseHeaders());
          (Se(
            function (e) {
              (t(e), h());
            },
        ...
        (m.open(r.method.toUpperCase(), r.url, !0),
          ...
          (m.onerror = function (t) {
            const r = new J(t && t.message ? t.message : 'Network Error', J.ERR_NETWORK, e, m);
            ((r.event = t || null), n(r), (m = null));
          }),
          (m.ontimeout = function () {
            let t = r.timeout ? 'timeout of ' + r.timeout + 'ms exceeded' : 'timeout exceeded';
            const o = r.transitional || oe;
            (r.timeoutErrorMessage && (t = r.timeoutErrorMessage),
              n(new J(t, o.clarifyTimeoutError ? J.ETIMEDOUT : J.ECONNABORTED, e, m)),
              (m = null));
          }),
          void 0 === o && s.setContentType(null),
          'setRequestHeader' in m &&
            H.forEach(s.toJSON(), function (e, t) {
              m.setRequestHeader(t, e);
            }),
          H.isUndefined(r.withCredentials) || (m.withCredentials = !!r.withCredentials),
          f && 'json' !== f && (m.responseType = r.responseType),
          p && (([c, u] = Te(p, !0)), m.addEventListener('progress', c)),
          d && m.upload && (([a, l] = Te(d)), m.upload.addEventListener('progress', a), m.upload.addEventListener('loadend', l)),
          (r.cancelToken || r.signal) &&
            ((i = (t) => {
              m && (n(!t || t.type ? new Re(null, e, m) : t), m.abort(), (m = null));
            }),
        ...
        g && -1 === fe.protocols.indexOf(g) ? n(new J('Unsupported protocol ' + g + ':', J.ERR_BAD_REQUEST, e)) : m.send(o || null);
      });
    },
  _e = (e, t) => {
    ...
    if (t || n) {
      ...
      const o = function (e) {
        if (!n) {
          ...
          r.abort(t instanceof J ? t : new Re(t instanceof Error ? t.message : t));
        }
      };
      let s =
        t &&
      ...
      const { signal: a } = r;
      return ((a.unsubscribe = () => H.asap(i)), a);
    }
  },
  Le = function* (e, t) {
    let n = e.byteLength;
  ...
  Be = (e, t, n, r) => {
    const o = (async function* (e, t) {
      for await (const n of ke(e)) yield* Le(n, t);
    })(e, t);
    let s,
      i = 0,
      a = (e) => {
  ...
  { isFunction: De } = H,
  qe = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(H.global),
  { ReadableStream: Me, TextEncoder: Ie } = H.global,
  ze = (e, ...t) => {
    try {
      return !!e(...t);
    } catch (n) {
  ...
  He = (e) => {
    e = H.merge.call({ skipUndefined: !0 }, qe, e);
    const { fetch: t, Request: n, Response: r } = e,
      o = t ? De(t) : 'function' == typeof fetch,
      s = De(n),
      i = De(r);
    if (!o) return !1;
    const a = o && De(Me),
      ...
      u = i && a && ze(() => H.isReadableStream(new r('').body)),
      f = { stream: u && ((e) => e.body) };
    o &&
      ...
      return null == r
        ? (async (e) => {
            ...
            if (H.isSpecCompliantForm(e)) {
              const t = new n(fe.origin, { method: 'POST', body: e });
              return (await t.arrayBuffer()).byteLength;
            }
            return H.isArrayBufferView(e) || H.isArrayBuffer(e)
              ? e.byteLength
              : (H.isURLSearchParams(e) && (e += ''), H.isString(e) ? (await c(e)).byteLength : void 0);
          })(t)
        : r;
    };
    return async (e) => {
      ...
      let R = _e([c, p && p.toAbortSignal()], h),
        S = null;
      const T =
        R &&
        R.unsubscribe &&
      ...
      let A;
      try {
        if (b && l && 'get' !== i && 'head' !== i && 0 !== (A = await d(y, a))) {
          let e,
            t = new n(o, { method: 'POST', body: a, duplex: 'half' });
          if ((H.isFormData(a) && (e = t.headers.get('content-type')) && y.setContentType(e), t.body)) {
            const [e, n] = Ae(A, Te(ve(b)));
            a = Be(t.body, 65536, e, n);
          }
        }
        H.isString(w) || (w = w ? 'include' : 'omit');
        ...
        S = s && new n(o, c);
        let p = await (s ? O(S, E) : O(o, c));
        const h = u && ('stream' === g || 'response' === g);
        if (u && (m || (h && T))) {
          const e = {};
          ['status', 'statusText', 'headers'].forEach((t) => {
            e[t] = p[t];
          });
          const t = H.toFiniteNumber(p.headers.get('content-length')),
            [n, o] = (m && Ae(t, Te(ve(m), !0))) || [];
          p = new r(
            Be(p.body, 65536, n, () => {
              (o && o(), T && T());
            }),
        ...
        g = g || 'text';
        let v = await f[H.findKey(f, g) || 'text'](p, e);
        return (
          !h && T && T(),
          await new Promise((t, n) => {
            Se(t, n, { data: v, headers: we.from(p.headers), status: p.status, statusText: p.statusText, config: e, request: S });
          })
        );
      } catch (v) {
        if ((T && T(), v && 'TypeError' === v.name && /Load failed|fetch/i.test(v.message)))
          throw Object.assign(new J('Network Error', J.ERR_NETWORK, e, S), { cause: v.cause || v });
        throw J.from(v, v && v.code, e, S);
      }
    };
  },
  Je = new Map(),
  We = (e) => {
    ...
    let i,
      ...
      c = s.length,
      l = Je;
    for (; c--; ) ((i = s[c]), (a = l.get(i)), void 0 === a && l.set(i, (a = c ? new Map() : He(t))), (l = a));
    return a;
  };
We();
const Ke = { http: null, xhr: Fe, fetch: { get: We } };
H.forEach(Ke, (e, t) => {
  if (e) {
    try {
...
const Ve = (e) => `- ${e}`,
  ...
  Xe = (e, t) => {
    ...
    for (let i = 0; i < n; i++) {
      let n;
      if (((r = e[i]), (o = r), !$e(r) && ((o = Ke[(n = String(r)).toLowerCase()]), void 0 === o))) throw new J(`Unknown adapter '${n}'`);
      if (o && (H.isFunction(o) || (o = o.get(t)))) break;
      s[n || '#' + i] = o;
    }
    if (!o) {
      ...
      throw new J(
        'There is no suitable adapter to dispatch the request ' +
          (n ? (e.length > 1 ? 'since :\n' + e.map(Ve).join('\n') : ' ' + Ve(e[0])) : 'as no adapter specified'),
        'ERR_NOT_SUPPORT',
      );
    }
    return o;
...
function Qe(e) {
  ...
  return Xe(
    e.adapter || pe.adapter,
    e,
  )(e).then(
    function (t) {
      return (Ge(e), (t.data = Ee.call(e, e.transformResponse, t)), (t.headers = we.from(t.headers)), t);
    },
    function (t) {
      return (
        Oe(t) ||
          ...
          t &&
            t.response &&
            ((t.response.data = Ee.call(e, e.transformResponse, t.response)), (t.response.headers = we.from(t.response.headers)))),
        Promise.reject(t)
      );
    },
  );
...
((Ye.transitional = function (e, t, n) {
  return (r, o, s) => {
    if (!1 === e)
      throw new J(
        (function (e, t) {
          return '[Axios v' + Ze + "] Transitional option '" + e + "'" + t + (n ? '. ' + n : '');
        })(o, ' has been removed' + (t ? ' in ' + t : '')),
        J.ERR_DEPRECATED,
      );
    return (t && !et[o] && (et[o] = !0), !e || e(r, o, s));
  };
}),
    ...
    assertOptions: function (e, t, n) {
      ...
      for (; o-- > 0; ) {
        ...
        if (i) {
          const t = e[s],
            n = void 0 === t || i(t, s, e);
          if (!0 !== n) throw new J('option ' + s + ' must be ' + n, J.ERR_BAD_OPTION_VALUE);
          continue;
        }
        if (!0 !== n) throw new J('Unknown option ' + s, J.ERR_BAD_OPTION);
      }
    },
    validators: Ye,
  },
...
let rt = class {
    ...
    (void 0 !== n &&
      ...
      null != r &&
        (H.isFunction(r)
          ...
          : tt.assertOptions(r, { encode: nt.function, serialize: nt.function }, !0)),
      ...
      tt.assertOptions(t, { baseUrl: nt.spelling('baseURL'), withXsrfToken: nt.spelling('withXSRFToken') }, !0),
      (t.method = (t.method || this.defaults.method || 'get').toLowerCase()));
    let s = o && H.merge(o.common, o[t.method]);
    (o &&
  ...
  getUri(e) {
    return ne(xe((e = Pe(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls), e.params, e.paramsSerializer);
  }
};
(H.forEach(['delete', 'get', 'head', 'options'], function (e) {
  rt.prototype[e] = function (t, n) {
    return this.request(Pe(n || {}, { method: e, url: t, data: (n || {}).data }));
  };
}),
  H.forEach(['post', 'put', 'patch'], function (e) {
    function t(t) {
      return function (n, r, o) {
        return this.request(Pe(o || {}, { method: e, headers: t ? { 'Content-Type': 'multipart/form-data' } : {}, url: n, data: r }));
      };
    }
...
const st = (function e(n) {
  const r = new rt(n),
    o = t(rt.prototype.request, r);
  return (
    H.extend(o, rt.prototype, r, { allOwnKeys: !0 }),
...
((st.Axios = rt),
  ...
  (st.mergeConfig = Pe),
  (st.AxiosHeaders = we),
  (st.formToJSON = (e) => de(H.isHTMLForm(e) ? new FormData(e) : e)),
  (st.getAdapter = Xe),
  (st.HttpStatusCode = ot),
  (st.default = st));
const {
    Axios: it,
    AxiosError: at,
  ...
  Rt = st.create({ withCredentials: !1, timeout: 1e4 });
...
const St = {
  get: (e, t) => Rt.get(e, t),
  post: (e, t, n) => Rt.post(e, t, n),
  put: (e, t, n) => Rt.put(e, t, n),
  delete: (e, t) => Rt.delete(e, t),
};
export { St as h };
