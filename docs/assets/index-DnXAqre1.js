/* empty css              */ import { r as e, u as t, B as a } from './index-CDvEa1lQ.js';
...
import { u as ue, P as ce, s as de } from './function-call-BAKncopg.js';
import './index-DpJkkFdY.js';
import { u as me } from './use-height-BE99OTuR.js';
r('picker-toolbar');
...
const at = Xe(
  ...
  jt = ie(
    W({
      __name: 'index',
      setup(e) {
        at.locale('zh-cn', { weekdays: ['星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六'] });
        const t = R({ adult: { num: 0, simpleText: '大' }, child: { num: 0, simpleText: '小' }, senior: { num: 0, simpleText: '老' } }),
          ...
          o = R({ standard: 0.93, earlyBird: 0.95, costPlatform: 0.02 }),
          i = R(''),
          u = R(!1),
        ...
        const h = () => {
          ...
          let a = `${i.value} ${at(i.value).format('dddd')} ${e('adult')}${e('child')}${e('senior')}`;
