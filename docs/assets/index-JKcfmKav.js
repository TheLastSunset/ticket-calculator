...
import { t as X } from './data-DK6HM7Pn.js';
import { _ as Y, c as V } from './_plugin-vue_export-helper-1tPrXgE0-C-UiilIc.js';
    ...
    setup(t, { emit: a, slots: i, expose: n }) {
      const l = e(),
        ...
        X = ({ pace: e = 0, offset: i = 0, isEmit: n = !1 }) => {
          ...
          ((o.active = r), (o.offset = s), n && l !== o.active && a('change', S.value), E());
        },
        Y = () => {
