...
var W = (n, e) => ({ top: 0, left: 0, right: n, bottom: e, width: n, height: e }),
  q = (n) => {
    const e = p(n);
    if (e === window) {
    ...
    return (null == e ? void 0 : e.getBoundingClientRect) ? e.getBoundingClientRect() : W(0, 0);
  };
function J(n = !1) {
  const e = o(n);
  return [
...
function V(n, e, t) {
  ...
  t.sort((n, e) => G(o, n.vnode) - G(o, e.vnode));
...
const Yn = 'van-hairline',
  Hn = `${Yn}--bottom`,
  Rn = `${Yn}--surround`,
  Wn = `${Yn}--top-bottom`,
  qn = `${Yn}-unset--top-bottom`,
